...
- `pnpm pilot:production-database` produces the same redacted production database Gate report as Markdown or JSON for handoff, evidence folders, or CI-style stop/go checks without requiring Vercel API access.
