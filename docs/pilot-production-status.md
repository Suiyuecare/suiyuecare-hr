...
6. Use `pilot:rollout-kit` or `/settings/company-setup` for Day 1 instructions so rollout training stays under 10 minutes and announcement text stays privacy-safe.
