  ...
  await Promise.all([
    ...
    tx.leavePolicy.create({
      data: {
        ...
        code: "annual",
        name: "Annual leave",
        annualUnits: new Prisma.Decimal(0),
        unit: "day",
        statutoryCategory: "annual_leave",
        eligibilityRule: "hire_date_tiers",
        payRatePercent: new Prisma.Decimal(100),
        annualLimitNote: "Generated by Taiwan rule tiers during annual leave grant.",
        requiresLegalReview: false,
        accrualMethod: "hire_date_tiers",
        paid: true,
      },
    }),
