...
const profileInput = {
  ...
  wageInfo: "Wage summary reviewed.",
  laborInsuranceEnrollmentDate: new Date("2025-01-01T00:00:00.000Z"),
  rewardDisciplineSummary: "Reward and discipline summary reviewed.",
  injurySicknessSummary: "Injury and sickness summary reviewed.",
  otherNecessaryItems: "Other necessary items reviewed.",
