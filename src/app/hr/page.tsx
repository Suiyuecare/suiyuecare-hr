        ...
        <section className="panel span-12 payroll-console">
          ...
          {payroll.checklist.ruleReview.blocksLock ? (
            <div className="risk-box danger-box">
              ...
              {!payroll.checklist.ruleReview.sourceAuthorityPassed ? (
                <p className="muted">
                  法規來源 Gate：{payroll.checklist.ruleReview.untrustedLegalSourceCount} 個非官方來源，
                  {payroll.checklist.ruleReview.invalidLegalSourceUrlCount} 個無效網址。
                </p>
              ) : null}
            </div>
          ) : (
