...
function parseSnapshot(row: unknown): SupabasePilotTenantVerificationSnapshot {
  ...
  return {
    ...
    calendarDayCount: readNumber(record, "calendarDayCount"),
    approvedCalendarReviewCount: readNumber(record, "approvedCalendarReviewCount"),
    completeLaborRosterProfileCount: readNumber(record, "completeLaborRosterProfileCount"),
    approvedPolicyDocumentCount: readNumber(record, "approvedPolicyDocumentCount"),
    activeWorkRuleCount: readNumber(record, "activeWorkRuleCount"),
    workRuleAcknowledgementCount: readNumber(record, "workRuleAcknowledgementCount"),
    verifiedFileStorageCount: readNumber(record, "verifiedFileStorageCount"),
    externalNotificationSettingCount: readNumber(record, "externalNotificationSettingCount"),
    verifiedPayrollPaymentSecurityCount: readNumber(record, "verifiedPayrollPaymentSecurityCount"),
    readyWorktimeAgreementCount: readNumber(record, "readyWorktimeAgreementCount"),
    commercialSubscriptionCount: readNumber(record, "commercialSubscriptionCount"),
    backupPostureConfiguredCount: readNumber(record, "backupPostureConfiguredCount"),
