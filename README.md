...
- Taiwan labor rule source authority Gate requires HTTPS official `.gov.tw` sources; private legal databases, plain HTTP links, malformed URLs, or non-government hosts block launch readiness until replaced with official sources.
