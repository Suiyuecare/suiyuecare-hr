...
- 試用與上線工具：Supabase private schema 驗證、Vercel production env 草稿、20-50 人 pilot 匯入模板、匯入預檢、身份/SSO 匯入、邀請 readiness、核心流程 readiness、每日晨會摘要、每日狀態、每日戰情 today gate、證據掃描、go/no-go 開跑總檢查、邀請釋放 Gate、兩週試用結案檢查。
