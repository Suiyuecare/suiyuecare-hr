...
- Beta pilot readiness gate for the next implementation phase: checks whether a 20-50 person, two-week trial can safely run through employee mobile tasks, clock in/out, leave request, manager approval, announcements, HR payroll close rehearsal, released payslip viewing, audit coverage, and unauthorized payroll-access guardrails before a customer trial begins.
