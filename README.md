...
- Finance-style HR-managed policy source library for AI Copilot. Policy Q&A only cites active approved company policy excerpts and configured rules; draft or inactive sources are excluded.
