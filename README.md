...
The form wizard supports conditional HR review in plain language: HR can keep manager review as the first step and only route to HR when the first submitted field matches a configured answer, keeping routine requests short while still escalating sensitive cases.
