...
- 老闆/Owner 管理：公司設定、Finance-style 權限與登入中樞、資安與登入政策工作台、通知管道工作台、RBAC 角色、使用者邀請、員工主檔綁定、SSO subject hash 綁定、停用/復用帳號原因 hash、最後 active Owner 防呆、訂閱與商務狀態、支援存取授權、備份還原證據、上線 readiness、audit log 與勞檢證據包。
