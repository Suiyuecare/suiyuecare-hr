...
- 補齊 Vercel Production 真實環境變數：Supabase transaction pooler `DATABASE_URL`、正式 OIDC/SSO、vault/KMS 參照、備份還原演練證據，讓 `https://hr.suiyuecare.com/api/health/ready` 從 degraded 變成 ok。
